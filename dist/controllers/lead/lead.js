...
exports.parseLeadFiles = exports.updateLead = exports.getPerformance = exports.addGeolocation = exports.syncPhoneCalls = exports.uploadMultipleLeadFiles = exports.suggestLeads = exports.sendBulkEmails = exports.deleteOne = exports.patch = exports.findOneById = exports.insertOne = exports.getAllLeadColumns = exports.findAll = exports.getBasicOverview = exports.getLeadReassignmentHistory = exports.getLeadHistoryById = exports.getAllEmailTemplates = exports.createEmailTemplate = exports.reassignLead = exports.saveEmailAttachments = void 0;
...
exports.uploadMultipleLeadFiles = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ccnfg = yield CampaignConfig_1.default.find({ name: campaignName }, { readableField: 1, internalField: 1, _id: 0 }).lean().exec();
    if (!ccnfg) {
    ...
    const result = yield exports.parseLeadFiles(files, ccnfg, campaignName);
    // parse data here
...
exports.getPerformance = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
});
