...
let AgentService = class AgentService {
    ...
    getVisitTrack(id, roleType, organization, userIds) {
        return __awaiter(this, void 0, void 0, function* () {
            const subordinateIds = yield this.getSubordinates(id, roleType);
            const validUserIds = lodash_1.intersection(userIds, subordinateIds, [id]);
            common_1.Logger.debug(`validUserIds ${validUserIds}`);
