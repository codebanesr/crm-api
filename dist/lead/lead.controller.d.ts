...
export declare class LeadController {
    ...
    findOneById(leadId: string, user: User): Promise<{
        lead: Pick<import("./interfaces/lead.interface").Lead, "address" | "source" | "_id" | "email" | "fullName" | "organization" | "leadStatus" | "companyName" | "campaignId" | "archived" | "externalId" | "campaign" | "firstName" | "lastName" | "amount" | "state" | "followUp" | "pincode" | "nextAction" | "contact" | "requestedInformation" | "documentLinks" | "isPristine" | "transactionCount" | "notes">;
        leadHistory: any[];
    }>;
