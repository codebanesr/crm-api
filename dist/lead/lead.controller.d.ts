...
export declare class LeadController {
    ...
    getTransactions(user: User, query: GetTransactionDto, res: Response): Promise<Response<any>>;
    ...
    reassignLead(body: ReassignLeadDto, user: User): Promise<{
    ...
    findOneById(leadId: string, user: User): Promise<{
        lead: Pick<import("./interfaces/lead.interface").Lead, "address" | "source" | "_id" | "email" | "fullName" | "organization" | "leadStatus" | "companyName" | "externalId" | "campaign" | "firstName" | "lastName" | "amount" | "followUp" | "pincode" | "nextAction" | "documentLinks" | "notes" | "campaignId" | "contact" | "state" | "requestedInformation" | "isPristine" | "archived" | "transactionCount">;
        leadHistory: any[];
    }>;
    ...
    unarchiveLeads(buLeadsDto: BulkUnArchiveLeads): Promise<any>;
    transferLeads(tranferLeadsDto: TransferLeadsDto): Promise<Pick<any, string | number | symbol> | Pick<any, string | number | symbol>[]>;
    openClosedLeads(openClosedLead: OpenClosedLeadDto): Promise<any>;
}
